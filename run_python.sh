...
#DIR="/home/julen/Cloudlab/python/WASI-python-benchmarks/cpython::/"
#ENV="PYTHONPATH=/builddir/wasi-threads/build/lib.wasi-wasm32-3.13"
#EXE="/home/julen/Cloudlab/python/WASI-python-benchmarks/cpython/builddir/wasi-threads/python.wasm"
...
exec /home/julen/.wasmtime/bin/wasmtime run -S threads --wasm max-wasm-stack=8388608 --wasi preview2 --dir $DIR --env $ENV $EXE "$@"
